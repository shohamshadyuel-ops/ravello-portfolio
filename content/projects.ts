...
export const projects: Project[] = [
  ...
  {
    slug: "interior-design-studio-crm",
    title: "Interior Design Studio CRM",
    industry: "Design",
    summary:
      "Client journey platform for a premium interior design studio featuring mood board collaboration, vendor management, timelines, and invoice automation.",
    tags: ["Design", "Client Portal", "Vendors", "Invoicing"],
    keyFeatures: [
      "Client onboarding + brief capture with approval checkpoints",
      "Mood board collaboration and asset library",
      "Vendor directory with quotes, lead times, and purchase orders",
      "Project timelines with milestones and client sign-offs",
      "Invoice generation and payment tracking",
      "Change request workflow with scope tracking",
    ],
    integrations: ["Google Drive", "Stripe", "Calendly", "Email (SMTP)", "Slack"],
    automations: [
      "Automated client updates on milestone completion",
      "Vendor follow-ups for outstanding quotes",
      "Invoice reminders and payment confirmations",
      "Weekly status summaries to stakeholders",
    ],
    stack: ["Next.js", "PostgreSQL", "Prisma", "S3-compatible storage", "Stripe"],
    timeline: "6 weeks",
    outcomes: [
      "Single source of truth across clients, vendors, and assets",
      "Reduced project status back-and-forth by 55%",
      "Improved invoice collection speed by 30%",
    ],
    confidentialityLevel: "medium",
    images: [],
    demoPolicy: "Screenshare demo available upon request",
  },
  {
    slug: "marketing-agency-resource-planner",
    title: "Marketing Agency Resource Planner",
    industry: "Agency",
    summary:
      "Multi-client operations CRM for an agency with resource allocation, campaign tracking, client reporting dashboards, and automated status updates.",
    tags: ["Agency", "Planning", "Dashboards", "Automation"],
    keyFeatures: [
      "Resource planning by role, capacity, and timeline",
      "Campaign tracker with deliverables, approvals, and assets",
      "Client reporting dashboards with live KPIs",
      "Task management and internal handoff flows",
      "Client communication log + decision history",
      "Automated status summaries and weekly reports",
    ],
    integrations: ["Google Ads", "Meta Ads", "Slack", "Google Sheets", "Email (SMTP)"],
    automations: [
      "Weekly automated status updates to clients",
      "Capacity alerts when team utilization exceeds threshold",
      "Approval reminders for pending client feedback",
      "Auto-generated performance snapshots",
    ],
    stack: ["Next.js", "PostgreSQL", "Prisma", "Background jobs", "Charting"],
    timeline: "8 weeks",
    outcomes: [
      "Centralized operations across 20+ active clients",
      "Reduced planning overhead by 40%",
      "More consistent reporting cadence with fewer manual steps",
    ],
    confidentialityLevel: "medium",
    images: [],
    demoPolicy: "Private demo available upon request",
  },
  {
    ...
    summary:
      "Site coordination platform managing subcontractors, materials procurement, inspections, and budgets across multiple active projects.",
    tags: ["Construction", "Subcontractors", "Procurement", "Budgets"],
    keyFeatures: [
      "Subcontractor roster with scopes, documents, and compliance checks",
      "Materials procurement pipeline with approvals and lead times",
      "Inspection schedule management with evidence uploads",
      "Budget tracking with change orders and variance reporting",
      "Daily site log + issue tracking",
      "Stakeholder dashboards by role",
    ],
    integrations: ["Email (SMTP)", "S3-compatible storage", "Google Calendar", "PDF export"],
    automations: [
      "Inspection reminders and escalations",
      "Procurement follow-ups for overdue deliveries",
      "Budget variance alerts to project managers",
    ],
    stack: ["Next.js", "PostgreSQL", "Prisma", "File storage", "RBAC"],
    timeline: "10 weeks",
    outcomes: [
      "Clear visibility across schedules, budgets, and compliance",
      "Faster issue resolution through centralized tracking",
      "Reduced missed inspections and documentation gaps",
    ],
    confidentialityLevel: "medium",
    images: [],
    demoPolicy: "Private demo available upon request",
